    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-2 hover:border-accent transition-all hover:shadow-lg hover:-translate-y-1 duration-300">
      ...
      <section className="py-20 px-4 bg-accent">
        <div className="container mx-auto text-center">
          ...
          <Button asChild size="lg" variant="outline" className="bg-accent-foreground text-accent hover:bg-accent-foreground/90">
            <Link to="/contato">
